...
try:
    client = Client("https://03c6e9c038bc5b6cba.gradio.live")
except ValueError as e:
    print(f"Could not fetch config: {e}")
    client = None

#chatBot
gradio_client = Client("https://4e4687c8aa1c58fad1.gradio.live")

#dress
dress = Client("https://14a6832ad8ca8bdb8c.gradio.live")

#ocassion

ocassion_client = Client("https://4ff98c35d7343b8711.gradio.live")
